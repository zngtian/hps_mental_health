...
```{r}
df<- readRDS("hps_individual_week1_26.rds")
...
df$interest<-
  ifelse(df$interest ==1, 0, ifelse(df$interest ==2, 1, ifelse(df$interest ==3, 2, ifelse(df$interest ==4, 3,NA))))
df$down<-ifelse(df$down==1, 0, ifelse(df$down ==2, 1, ifelse(df$down ==3, 2, ifelse(df$down ==4, 3,NA))))
df$anxious<-ifelse(df$anxious ==1, 0, ifelse(df$anxious==2, 1, ifelse(df$anxious ==3, 2, ifelse(df$anxious ==4, 3,NA))))
df$worry<-ifelse(df$worry==1, 0, ifelse(df$worry ==2, 1, ifelse(df$worry ==3, 2, ifelse(df$worry==4, 3,NA))))
